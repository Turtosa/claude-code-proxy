...
class OpenAIClient:
    ...
    def __init__(self, api_key: str, base_url: str, timeout: int = 90, url_options: Optional[str] = None, api_version: Optional[str] = None):
        self.api_key = api_key
        self.base_url = base_url
        default_query = None

        if url_options is not None:
            default_query = {k: v[0] for k, v in urllib.parse.parse_qs(url_options).items()}
